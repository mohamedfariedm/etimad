...
function Certifications({ t }: { t: TFunction }) {
  return (
    <div className="main-container w-full lg:w-[1152px] lg:h-[381px] relative mx-auto my-0">
      ...
      <div className="flex justify-center items-center lg:block w-full lg:w-[1008px] h-[381px] bg-[url(/assets/images/certifications/Rectangle27.svg)] bg-cover bg-no-repeat rounded-[64px] lg:absolute top-0 end-[144px]">
