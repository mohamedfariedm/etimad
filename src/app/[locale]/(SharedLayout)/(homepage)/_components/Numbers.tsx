...
const ButtonCard = ({ value, description, image1, image2 }:{ value:string, description:string, image1:string, image2:string }) => (
  <div className="w-[270px] h-[120px] justify-center items-center flex shrink-0 border-none relative cursor-pointer group">
    ...
    <div className="w-[270px] h-[120px] rounded-[24px] absolute top-0 left-0 overflow-hidden">
      <div
      className="w-[270px] h-[120px]  rounded-[24px] absolute top-0 left-0 bg-contain bg-[url(/assets/images/numbers/after.svg)] group-hover:bg-[url(/assets/images/numbers/before.svg)] transition-all duration-500 ease-in-out" />
    </div>
  </div>
);
