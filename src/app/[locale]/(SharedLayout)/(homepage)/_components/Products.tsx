  ...
  const products = [
    {
      id: 1,
      title: "السفر",
      description: "لنجعل سفرك أسهل وأفضل عبر أفضل شركات السياحة المختارة.",
      image: "/assets/images/products/component5.svg",
    },
    {
      id: 2,
      title: "شباب طويق",
      description: "ندعم طلابنا في تمويل مستلزماتهم الدراسية الجامعية والمدرسية.",
      image: "/assets/images/products/component2.svg",
    },
    {
      id: 3,
      title: "الاستقدام",
      description: "نساعدك في تمويل تكاليف استقدام العمالة المنزلية بكل سهولة.",
      image: "/assets/images/products/component3.svg",
    },
    {
      id: 4,
      title: "التمويل الشخصي",
      description: "نوفر لك تمويلًا سريعًا ومرنًا يلبي احتياجاتك ومصاريفك الاستهلاكية.",
      image: "/assets/images/products/component4.svg",
    },
    {
      id: 5,
      title: "التجميل",
      description: "موّل احتياجاتك التجميلية وتكاليف العناية بك بسهولة ومرونة.",
      image: "/assets/images/products/component1.svg",
    },
    {
      id: 6,
      title: "سلعتي",
      description: "سدد مشترياتك واحتياجاتك اليومية بسهولة عبر خدماتنا المرنة والمميزة.",
