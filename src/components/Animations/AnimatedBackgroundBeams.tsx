...
function Background() {
  ...
  return (
    <div
      ref={containerRef}
      className="-z-1 absolute inset-0 flex h-full w-full flex-row justify-between bg-background-secondary"
    >
      <div
      ...
      {Array.from({ length: count }, (_, i) => (
        <div
          key={i}
          className="relative h-full w-px rotate-12 bg-gray-800 bg-opacity-20"
        >
...
export default function AnimatedBackgroundBeams({
  children,
  className,
}: {
