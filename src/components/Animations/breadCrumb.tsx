...
<div className="main-container flex w-[200px] gap-[12px] items-center flex-nowrap relative mx-auto mt-[164px] mb-[64px]">
      ...
      <span className="h-[20px] shrink-0 basis-auto  text-[14px] font-medium leading-[20px] text-[#90bbbd] relative text-left whitespace-nowrap z-[3]">
        الصفحة الرئيسية
      </span>
      ...
      className="w-[24px] h-[24px] shrink-0  bg-cover bg-no-repeat relative z-[2]"/>
